...
complete -c swaylock -l text                        --description "Draw the given text on the screen."
complete -c swaylock -l text-size                   --description "Sets a fixed font size for the screen text."
complete -c swaylock -l text-x-position             --description "Sets the horizontal position of the screen text."
complete -c swaylock -l text-y-position             --description "Sets the vertical position of the screen text."
complete -c swaylock -l text-shadow-color           --description "Sets the color of the screen text shadow."
complete -c swaylock -l text-shadow-offset          --description "Sets the screen text shadow offset in pixels."
complete -c swaylock -l text-outline-color          --description "Sets the color of the screen text outline."
complete -c swaylock -l text-outline-width          --description "Sets the outline width of the screen text in pixels."
